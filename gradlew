...
# Use the maximum available byte code version of the host JVM.
# This variable can be used by downstream tasks to determine maximum Java version.
# Defaults to minimum Java version supported by Gradle.
# Can be overridden by the user.

WARN_UPCOMING_DEPRECATION=true
